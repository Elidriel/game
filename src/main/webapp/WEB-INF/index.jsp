...
<div class="container">
 ...
 <!--       <c:forEach var="player" items="${players}">
            <tr>
                ...
                <th scope="col">${player.title}</th>
                <th scope="col">${player.race}</th>
                <th scope="col">${player.profession}</th>
                <th scope="col">${player.experience}</th>
                <th scope="col">${player.level}</th>
                <th scope="col">${player.untilNextLevel}</th>
                <th scope="col">${player.birthday}</th>
                <th scope="col">${player.banned}</th>
                <th scope="col"></th>
                <th scope="col"></th>
            </tr>
        </c:forEach>-->
